...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.23]{FigurasUV/varexp.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.32]{FigurasUV/2.pdf}
