...
~\\Para desarrollar nuestro código NIPALS en \citeasnoun{R}, nos basamos en el siguiente pseudocódigo propuesto por \citeasnoun{Vic}
\begin{itemize}
...
~\\Para realizar nuestro código de este algoritmo en \citeasnoun{R}, seguimos el pseudocódigo propuesto por \citeasnoun{Ochoa}
\begin{itemize}
...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=0.63]{FigurasUV/compcor.png}
\end{figure}
...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=0.4]{FigurasUV/nubeindcom.pdf}
\end{figure}
...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=0.45]{FigurasUV/ortocom.png}
\end{figure}
...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=0.45]{FigurasUV/ortovec.png}
\end{figure}
